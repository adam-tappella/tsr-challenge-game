/**
 * Magna TSR Challenge - Decision Cards Configuration
...
const GROW_DECISIONS: Decision[] = [
  // ===== ROUND 1 =====
  {
    ...
    name: 'EV Powertrain R&D Expansion',
    narrative: 'Invest in expanding R&D capabilities for next-generation electric vehicle powertrains. This positions Magna to capture growing EV market share but requires significant upfront investment with returns materializing over 2-3 years.',
    cost: 250,
    impactMagnitude: 4,
    introducedYear: 1,
    type: 'organic',
  ...
  },
  {
    ...
    category: 'grow',
    subcategory: 'Expand Manufacturing Footprint',
    name: 'European EV Assembly Facility',
    narrative: 'Build dedicated EV assembly plant in Eastern Europe. Positions for European EV mandate requirements. Significant investment with long payback period.',
    cost: 500,
    impactMagnitude: 4,
    introducedYear: 2,
    type: 'organic',
  ...
  },
  {
    ...
    category: 'grow',
    subcategory: 'Scale R&D for Next-Gen Portfolio',
    name: 'Lightweight Materials R&D',
    narrative: 'Expand research into advanced lightweight materials (carbon fiber, aluminum alloys) for EV range extension. Defensive investment as OEMs push for lighter vehicles.',
    cost: 180,
    impactMagnitude: 3,
    introducedYear: 2,
    type: 'organic',
  ...
  },
  {
    ...
    category: 'grow',
    subcategory: 'Enter New Geography / Market',
    name: 'India Manufacturing JV',
    narrative: 'Joint venture with Indian automotive group to enter fast-growing market. Local partner reduces execution risk but shares upside. Long-term market potential is significant.',
    cost: 220,
    impactMagnitude: 3,
    introducedYear: 2,
    type: 'inorganic',
  ...
  },
  {
    ...
    narrative: 'Strategic partnership with leading Chinese EV manufacturer. Access to largest EV market but geopolitical and IP concerns. High reward potential with elevated risk.',
    cost: 350,
    impactMagnitude: 4,
    introducedYear: 3,
    type: 'inorganic',
  ...
  },
  {
    ...
    category: 'grow',
    subcategory: 'Expand Manufacturing Footprint',
    name: 'North America EV Component Hub',
    narrative: 'Consolidate and expand EV component manufacturing in dedicated facility. Economies of scale but requires significant commitment during uncertain market conditions.',
    cost: 380,
    impactMagnitude: 4,
    introducedYear: 3,
    type: 'organic',
  ...
  },
  {
    ...
    category: 'grow',
    subcategory: 'Platform-Level Technology Bets',
    name: 'Electric Skateboard Platform',
    narrative: 'Develop flexible EV skateboard platform that can underpin multiple vehicle types. Major investment during downturn positions for recovery leadership.',
    cost: 550,
    impactMagnitude: 5,
    introducedYear: 4,
    type: 'organic',
  ...
  },
  {
    ...
    narrative: 'Join consortium developing hydrogen fuel cell technology for commercial vehicles. Hedges EV bet but requires ongoing investment with uncertain payoff timeline.',
    cost: 180,
    impactMagnitude: 2,
    introducedYear: 4,
    type: 'inorganic',
  ...
  // ===== ROUND 5 =====
  {
    ...
    narrative: 'Acquire emerging technology company with breakthrough EV thermal management system. Positions for next-generation vehicle requirements. Premium valuation as market recovers.',
    cost: 400,
    impactMagnitude: 4,
    introducedYear: 5,
    type: 'inorganic',
